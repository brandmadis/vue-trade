...
function getById(id) {
    ...
    return fetch(`${process.env.VUE_APP_API_URL}/users/${id}`, requestOptions).then(handleResponse);
}
...
function update(user) {
    ...
    return fetch(`${process.env.VUE_APP_API_URL}/users/${user.id}`, requestOptions).then(handleResponse);
}
